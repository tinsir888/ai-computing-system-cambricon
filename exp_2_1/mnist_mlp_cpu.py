...
class MNIST_MLP(object):
    def __init__(self, batch_size=200, input_size=784, hidden1=400, hidden2=100,hidden3=32,out_classes=10,lr=0.01, max_epoch=30,print_iter=50):
...
def build_mnist_mlp(param_dir='weight.npy'):
    h1, h2, h3, e = 400, 100, 32, 30
    mlp = MNIST_MLP(hidden1=h1, hidden2=h2, hidden3=h3, max_epoch=e)
    mlp.load_data()
    mlp.build_model()
    mlp.init_model()
    mlp.train()
    mlp.save_model('mlp-%d-%d-%d-%depoch.npy' % (h1, h2, h3,  e))#添加一层
